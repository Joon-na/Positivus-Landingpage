...
<section class="flex flex-col lg:flex-row items-center justify-between bg-[#F3F3F3] rounded-[45px] relative overflow-hidden lg:h-[773px] px-4 sm:px-6 py-10 mb-[140px]">
    <div class="w-full max-w-[600px] mx-auto">
        <div class="flex items-center justify-center lg:justify-start space-x-6 mb-6">
            <label class="flex items-center space-x-2 cursor-pointer">
                ...
                <div class="w-5 h-5 border border-black rounded-full flex items-center justify-center peer-checked:border-black">
        ...
        <form class="space-y-4">
            <div>
                ...
                <input type="text" class="w-full px-4 py-3 border border-black rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Name">
            </div>
            <div>
                <label class="block text-black text-sm mb-2">Email*</label>
                <input type="email" class="w-full px-4 py-3 border border-black rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Email">
            </div>
            <div>
                <label class="block text-black text-sm mb-2">Message*</label>
                <textarea class="w-full px-4 py-3 border border-black rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" rows="4" placeholder="Message"></textarea>
            </div>
    ...
    <div class="hidden relative lg:block lg:right-72 lg:w-[700px]">
        <img src="/images/home/contact.png" alt="Contact Illustration" class="w-full top-[-320px] right-[-640px] absolute object-cover">
    </div>
</section>
